...
class ItemController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function ($item) {
                    return '
                    <a class="block w-full px-2 py-1 mb-1 text-xs text-center text-white transition duration-500 bg-gray-700 border border-gray-700 rounded-md select-none ease hover:bg-gray-800 focus:outline-none focus:shadow-outline" href="' . route('admin.items.edit', $item->id) . '">
                        Sunting
                    </a>
    ...
    public function edit(Item $item)
    {
        ...
        return view('admin.items.edit', compact('brands', 'types', 'item'));
    }
    ...
    public function update(ItemRequest $request, Item $item)
    {
        ...
        //Upload multiple photo, if there is a new photo
