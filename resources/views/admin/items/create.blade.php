    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('admin.items.store') }}" method="post" class="w-full"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 mx-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" id="grid-last-name"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 mx-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="features" value="{{ old('features') }}" id="grid-last-name"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 mx-3">
                        <div class="w-full">
                            ...
                            <input type="file" name="photos[]" value="{{ old('photos') }}" id="grid-last-name"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                    ...
                    <div class="grid grid-cols-3 gap-3 px-3 mt-4 mb-6 mx-3">
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="price" value="{{ old('price') }}" id="grid-last-name"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                placeholder="Price">
                            <div class="mt-2 text-sm text-gray-500">
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="star" value="{{ old('star') }}" id="grid-last-name"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="review" value="{{ old('review') }}" id="grid-last-name"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
